...
const handlePaymentSuccess = async (details) =>{
  try{
        ...
        {paymentStatus: "paid", paymentDetails: details},
    {
        ...
        await handleFinalizedCheckout(checkoutId); // Finalize check out if payment is succesfull
        ...
        {cart.products.map((product, index) => (
            <div key={index} className="flex items-start justify-between py-2 border-b">
                <div className="flex items-start ">
                 ...
                 <p className="text-xl ">${product.price?.toLocaleString()}
                </p>
            </div>
        ))}
    </div>
...
<div className='flex justify-between items-center text-lgmt4 border-t pt-4'>
    <p>Total</p>
    <p>${cart.totalPrice?.toLocaleString()}</p>
</div>
    </div>
