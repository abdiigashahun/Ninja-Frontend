...
// @desc Update an exsiting product ID
// @access Private/Admin
...
try {
    ...
    if(product) {
        ...
        res.json({messge: "Product Removed"})
    }else{
        res.status(404).json({message: "Product not found"});
    }
} catch (error){
...
// @dsec Retrieve the product with highest rating
// @access Public
...
// @desc Retrieve similar products based on the current product's and category
// @access Public
